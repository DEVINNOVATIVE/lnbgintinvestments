...
const services = [
  { icon: Target, title: 'Business Strategy', desc: 'Partnering with leading-edge digital companies to expand our portfolio and pass on those services to our clients.' },
  { icon: BarChart3, title: 'Asset Management', desc: 'Our asset management services are built around portfolio management to optimise returns for our clients.' },
  { icon: Building2, title: 'Corporate Investments', desc: 'We carry out highly selective investments in regions and entities where there is high potential.' },
  { icon: LineChart, title: 'Markets Research', desc: 'For the past 25 years we have designed and implemented virtually every type of business research for hundreds of clients.' },
  { icon: Cpu, title: 'Technology Solutions', desc: 'Automated process control systems and digital transformation strategies built through our professional network.' },
  { icon: ShieldCheck, title: 'Risk Management', desc: 'Proactive risk assessment and mitigation frameworks that protect your assets and ensure sustainable growth.' },
  { icon: Globe, title: 'International Trade', desc: 'Cross-border trade financing and supply chain optimization solutions across 25+ countries.' },
  { icon: Bitcoin, title: 'Digital Assets', desc: 'Crypto infrastructure and algorithmic trading systems for institutional clients.' },
];
