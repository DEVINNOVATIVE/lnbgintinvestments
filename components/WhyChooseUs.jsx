        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative pb-12 sm:pb-16 lg:pb-20 pr-6 sm:pr-12">
            ...
            <div className="relative w-full h-[380px] sm:h-[460px] rounded-2xl overflow-hidden shadow-xl border border-slate-100 group">
              <Image
                ...
                fill
                quality={100}
                unoptimized // Guarantees maximum sharpness without Next.js compression blur
                className="object-cover object-center group-hover:scale-105 transition-transform duration-700 ease-out"
              />
            </div>

            {/* Overlapping Floating Foreground Image (Small Card) */}
            <div className="absolute bottom-0 right-0 w-[70%] sm:w-[65%] h-[220px] sm:h-[270px] rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.25)] border-8 border-white group z-20">
              <Image
                ...
                fill
                quality={100}
                unoptimized // Guarantees maximum sharpness
                className="object-cover object-center group-hover:scale-105 transition-transform duration-700 ease-out"
              />
            </div>
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-2">
              ...
              {/* Feature 1 */}
              <div className="group flex flex-col justify-between p-6 bg-white rounded-3xl border border-slate-100/90 shadow-lg shadow-slate-200/50 hover:border-red-200 hover:shadow-xl hover:shadow-red-600/10 hover:-translate-y-1 transition-all duration-300">
